...
print("""
 ...
 _   | |   `'_\ :  [ \ [  ] `'_\ :  / /'`\' |  |______|   |  _|    `'_\ :  [ `/'`\] / /'`\' |  
| |__' |   // | |,  \ \/ /  // | |, | \__/  |            _| |_     // | |,  | |     | \__/  |  
`.____.'   \'-;__/   \__/   \'-;__/  '.__.;__]          |_____|    \'-;__/ [___]     '.__.;__] 
...
'adm/index.brf','adm.brf','affiliate.brf','adm_auth.brf','memberadmin.brf','administratorlogin.brf','cpanel','cpanel.php','cpanel.html','admin/','administrator/','login.php','administration/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
